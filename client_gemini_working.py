"""LangChain 에이전트가 MCP tool을 사용하는 예제 (작동 확인됨).

이 클라이언트는 stdio 기반의 YouTube Summary MCP 서버를 사용합니다.
SSE 방식보다 안정적이고 바로 작동합니다.
...
3. 영상의 메타데이터 (제목, 채널, 길이 등)"""
    ...
    logger.info("분석 중...")
    print("\n" + "=" * 60)
    print("YouTube 영상 분석 결과 (Gemini LLM + MCP)")
    print("=" * 60)
